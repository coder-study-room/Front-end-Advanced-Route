...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192217.png)

新版 chrome 控制台可以将打印信息分类：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192248.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192305.png)

### 添加 CSS 样式

- %c - 样式

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192324.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192346.png)

### 输出 HTML 元素

按照 HTML ELements 结构输出：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192407.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192444.png)

### console.group( ) & console.groupEnd( )

接下来是另一个富文本能力，按分组输出：
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192501.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192522.png)

### console.assert( )

`console` 版断言工具，当且仅当第一个参数值为 `false` 时才打印第二个参数作为输出。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192540.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192559.png)

### console.time( )

打印代码执行时间，性能优化和监控场景比较常见。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192618.png)

### console.memory

打印内存使用情况。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409192639.png)
