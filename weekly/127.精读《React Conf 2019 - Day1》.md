...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190559.png)

先加载代码，然后会渲染页面，在渲染的同时发取数请求，等取数完成后才能渲染出真实数据。

那么如何改善这个情况呢？首先是预取数，提前解析出请求并在脚本加载的同时取数，可以节省大量时间：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190630.png)

那么下载的代码可以再拆分吗？注意到并不是所有代码都作用于 UI 渲染，我们可以将模块分为 `ImportForDisplay` 与 `importForAfterDisplay` ：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190646.png)

这样就可以优先加载与 UI 相关的代码，其余逻辑代码在页面展示出之后再加载：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190705.png)

这样可以实现源码分段加载，并分段渲染：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190726.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190748.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190811.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409190825.png)
