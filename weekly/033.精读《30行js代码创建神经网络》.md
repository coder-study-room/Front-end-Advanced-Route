...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182246.png)

知道了 Sigmoid 函数了，我们可以看一个具体的 **Sigmoid 神经元** 例子。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182308.png)

在这个例子中 `7` 和 `3` 是**权重**参数，`-2` 是**偏差**，最左边的 `1` 和 `0` 是 **输入层** 中的两个节点，通过如下的计算，得到了一个 **隐藏层** 节点 `5`。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182327.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182339.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182357.png)

当我们输`[0, 0]`时，我们选取一些任意的权重和偏差，计算过程如下：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182418.png)

为了方便后续的推到，我们可以通过一些符号来简单的描述一下`h1`和最终记过`output`计算的过程:

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182435.png)


计算得到结果 `o` 后，我们可以通过平方误差函数

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182454.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182511.png)

得到 `w5` 对应的偏导后，我们通过下面的公式来计算新的`w5`参数:

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182539.png)
