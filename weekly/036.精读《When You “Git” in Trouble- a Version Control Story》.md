...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182837.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182856.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182909.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182925.png)
 
查看 objects 目录，只新增了一个 30 目录，即 30d67d4672d5c05833b7192cc77a79eaafb5c7ad 对应的 file2.js 文件。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182943.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408182959.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183018.png)

查看 dir1 对应的 tree 对象的内容，该 tree 对象只包含 file2.js 的信息。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183040.png)

当前项目的 git 仓库内部结构图如下：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183052.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183106.png)

目前每个目录里有一个对象，共 5 个对象，之前的总体 tree 图只包含了 4 个对象，执行 git log 查看 commit 记录。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183124.png)
 
objects 中 65 对应的文件夹里面的文件就是 commit 对象，它指向项目目录 tree 以及上一次的 commit，由于是第一个 commit，因此不存在上一个 commit。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183159.png)
 
commit 对象内容指向项目目录 tree，所以能获取到一个 commit，可以得到当前完整的文件状况，objects 结构图如下：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183218.png)

再新增一个目录 dir2，该目录下新增文件 file3.js，执行 git add 和 git commit 后查看新的 commit 信息。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183234.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183255.png)

可以看到 commit 对象指向了工作目录 tree，因此只要切换 commit，就可以随意切换对应的版本内容，当前 .git/objects 目录内容如下：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210408183322.png)
