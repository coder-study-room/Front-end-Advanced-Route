...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409182831.png)

可以看到，导入的数据格式有些问题，这是因为这份 Excel 文件表头有一些描述信息干扰。勾选 **Use Data Interpreter** 后，可以开启数据解析功能，自动分析出你想要的表结构：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409182854.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409182913.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409182955.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183016.png)

我们可以看到，无论是销量还是利润都在逐年上升。**接下来我们想具体看看每个月份的数据**：

1. 右键 Order Date，将日期维度从年切换到月。

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183034.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183050.png)
...
**我们再看看数据按月分布情况**，同样右击 Order Date，选择月粒度：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183112.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183134.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183152.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183211.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183230.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183326.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183350.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183414.png)

我们就可以将 Product 直接拖拽到画布区域，并选择矩形树图，通过点击指标上的 “+” “-” 号进行上卷或下钻：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183433.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183452.png)

点击 Analytics Tab，将 Trend Line 拖入 chart 中：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183521.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183540.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183606.png)

从上图可以看到，指定了 4 个分类，最右上角加州就是最突出的一组，整个聚类只有它一个元素，而画面偏左下角的也是一类，这些是业绩较差的一组数据。使用了 K 均值聚类算法，并且当你点击右键查看详细星系时，还能把组间、组内方差展示出来：

![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183629.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183651.png)
...
![](https://cdn.jsdelivr.net/gh/ViktorWong/imgbed/img/20210409183710.png)
